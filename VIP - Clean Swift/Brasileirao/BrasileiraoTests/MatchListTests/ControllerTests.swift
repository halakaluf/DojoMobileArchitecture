...
class MatchListControllerTests: XCTestCase {
    ...
    func testShouldFetchPreviewsMatchesWhenPreviewsButtomClicked() {
        ...
        // Then
        XCTAssert(matchListBusinessLogicSpy.fetchPreviusMatches, "Deveria chamar fetchNextMatches quando botão next é clicado!")
    }
